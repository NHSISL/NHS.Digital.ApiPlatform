...
using NHS.Digital.ApiPlatform.Sdk.Models.Foundations.CareIdentityServices.Exceptions;
using Xeptions;

namespace NHS.Digital.ApiPlatform.Sdk.Services.Foundations.CareIdentityServices
{
